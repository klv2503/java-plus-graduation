...
public class AdminEventController {
    ...
    public ResponseEntity<List<EventFullDto>> getEvents(
        ...
        log.debug("\nAdmin requested events with filters: users={}, states={}, categories={}, rangeStart={}, rangeEnd={}, from={}, size={}",
    ...
    @GetMapping("/{eventId}")
    public ResponseEntity<EventFullDto> getEventInfo(@PathVariable @NotNull @Positive Long eventId) {
