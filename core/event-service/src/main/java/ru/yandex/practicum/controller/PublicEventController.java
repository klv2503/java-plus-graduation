...
import ru.yandex.practicum.service.PublicEventsService;
import ru.yandex.practicum.validation.SearchParamsValidator;
...
public class PublicEventController {
    ...
    @GetMapping("/list")
    public ResponseEntity<List<Event>> getEventsByListIds(@RequestParam List<Long> ids) {
        return ResponseEntity.ok(publicEventsService.getEventsByListIds(ids));
    }
